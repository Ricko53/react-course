...
class CourseList extends React.Component {
  ...
  handleClick(e, cid) {
    ...
    this.props.dispatch({type: 'app/getCourseDetail', payload: cid}).then(res => {
      this.setState({
        showDetail: true,
      })
    })
  ...
  render() {
      ...
      return(
        <article className="course-page">
          ...
          <CourseDetail showDetail={this.state.showDetail} info={this.state.baseInfo} courseInfo={courseDetail} closeDetail={this.closeDetailFunc}></CourseDetail>
        </article>
      )
  }
}
...
export default connect(app => app)(CourseList)